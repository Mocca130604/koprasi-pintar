...
<html lang="en">
  ...
  <link rel="icon" href="{{ asset('tailadmin/favicon.ico') }}"><link href="{{ asset('tailadmin/style.css') }}" rel="stylesheet"></head>
  <body
          ...
          <li>
            ...
            >
              ...
              >
                <li>
                  <a
                    href="/tailadmin/form-elements.html"
                    class="menu-dropdown-item group"
          ...
          <li>
            ...
            >
              ...
              >
                <li>
                  <a
                    href="/tailadmin/basic-tables.html"
                    class="menu-dropdown-item group"
          ...
          <li>
            ...
            >
              ...
              >
                <li>
                  <a
                    href="/tailadmin/line-chart.html"
                    class="menu-dropdown-item group"
...
<!-- ====== Table One End -->
    ...
    <!-- ===== Page Wrapper End ===== -->
  <script defer src="{{ asset('tailadmin/bundle.js') }}"></script></body>
</html>
